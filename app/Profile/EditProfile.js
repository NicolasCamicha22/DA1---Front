...
const uploadImageToBackend = async (imageUri) => {
    ...
    try {
        ...
        const response = await fetch('https://da1back.onrender.com/api/auth/upload', {
            method: 'POST',
...
export default function EditProfile() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await axios.put('https://da1back.onrender.com/api/users/profile', updatedData, {
                headers: {
    ...
    const deleteUser = async () => {
        ...
        try {
            const response = await axios.delete(`https://da1back.onrender.com/api/auth/delete-account`, {
                headers: {
