...
const SearchScreen = () => {
    ...
    const toggleFollow = async (followingId, isFriend) => {
        ...
        try {
            ...
            if (isFriend) {
                ...
                response = await axios.delete(`https://da1back.onrender.com/api/friends/${followingId}`, {
                    headers: {
                ...
                response = await axios.post('https://da1back.onrender.com/api/friends/request', {
    ...
    const handleSearch = async (text) => {
        ...
        try {
            const response = await axios.get('https://da1back.onrender.com/api/users/search', {
            ...
            const friendsResponse = await axios.get('https://da1back.onrender.com/api/friends', {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
