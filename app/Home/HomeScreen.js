...
import { useNavigation } from '@react-navigation/native'; // Para navegar a la pantalla de búsqueda
...
export default function HomeScreen() {
    ...
    const [hasPosts, setHasPosts] = useState(true); // Nuevo estado para controlar si hay publicaciones

    const navigation = useNavigation(); // Navegación a otras pantallas
    ...
    const goToSearchScreen = () => {
        navigation.navigate('SearchScreen'); // Navega a la pantalla de búsqueda
    };
        ...
        <View style={styles.container}>
            ...
            {hasPosts ? (
                ...
                <View style={styles.noPostsContainer}>
                    ...
                    <Icon name="person-outline" size={80} color="#bbb" />
